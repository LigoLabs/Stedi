...
| Fichier | Rôle |
|---|---|
| [`index.html`](index.html) | page + écrans superposés (accueil, cinématique d'intro, fiche projet, contact, HUD) |
...
| `assets/ui/` | habillage : cadres, écriteau, flèche, icônes de contact, fond de l'accueil |
